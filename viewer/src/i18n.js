...
const FR = {
  ...
  'This briefing is stored only in this browser and cannot be shared by link.': 'Ce briefing est enregistré uniquement dans ce navigateur et ne peut pas être partagé par lien.',
  'This shared analysis is unavailable.': 'Cette analyse partagée est indisponible.',
  'Could not copy the link. Please try again.': 'Impossible de copier le lien. Veuillez réessayer.',
  ...
  'NOW': 'MAINTENANT',
  // Planner GRIB export (pages/planner/GribExport.jsx, lib/gribExport.js, engine GRIB registry).
  'Download GRIBs…': 'Télécharger des GRIB…',
  'Download GRIBs': 'Télécharger des GRIB',
  'GRIB download': 'Téléchargement GRIB',
  'GRIB2 files of the forecast for your route area, built in your browser from the same forecast runs as your briefings. For GRIB viewers and routing software such as Adrena, OpenCPN, qtVlm or XyGrib.': 'Fichiers GRIB2 de la prévision pour la zone de votre route, créés dans votre navigateur à partir des mêmes cycles de prévision que vos briefings. Pour les logiciels de lecture GRIB et de routage comme Adrena, OpenCPN, qtVlm ou XyGrib.',
  'Local test tiles, not the live forecast.': 'Tuiles de test locales, pas la prévision en direct.',
  'Longitude test setting: −180 to 180° (signed).': 'Réglage de test des longitudes : −180 à 180° (signées).',
  'Margin around the route': 'Marge autour de la route',
  'Time step': 'Pas de temps',
  'Every forecast step': 'Toutes les échéances',
  'Every 3 h': 'Toutes les 3 h',
  'Every 6 h': 'Toutes les 6 h',
  'Window': 'Fenêtre',
  'Passage window': 'Fenêtre de la traversée',
  'Full forecast': 'Prévision complète',
  'From your departure (or now, if later) to the end of each forecast: every file runs to its own model’s last step. The dashed box on the chart is the area.': 'De votre départ (ou de maintenant, s’il est passé) jusqu’à la fin de chaque prévision : chaque fichier va jusqu’à la dernière échéance de son modèle. Le cadre en pointillés sur la carte délimite la zone.',
  'From your departure (or now, if later) to the estimated arrival plus 24 h. The dashed box on the chart is the area.': 'De votre départ (ou de maintenant, s’il est passé) jusqu’à l’arrivée estimée plus 24 h. Le cadre en pointillés sur la carte délimite la zone.',
  'Loading the forecast runs…': 'Chargement des cycles de prévision…',
  'The forecast runs are unavailable, so GRIB files can’t be prepared right now.': 'Les cycles de prévision sont indisponibles : impossible de préparer des fichiers GRIB pour le moment.',
  'This area can’t be exported (it may cross the 180° meridian).': 'Cette zone ne peut pas être exportée (elle traverse peut-être le méridien 180°).',
  'Datasets': 'Jeux de données',
  'Not in the current forecast runs.': 'Absent des cycles de prévision actuels.',
  'No data for this area.': 'Aucune donnée pour cette zone.',
  'Your dates are beyond this forecast’s range.': 'Vos dates dépassent la portée de cette prévision.',
  'Partial coverage: this regional model covers only part of the area. The rest of the file is left empty.': 'Couverture partielle : ce modèle régional ne couvre qu’une partie de la zone. Le reste du fichier est laissé vide.',
  'Cancel': 'Annuler',
  'GRIB export progress': 'Progression de l’export GRIB',
  'Reading forecast tiles': 'Lecture des tuiles de prévision',
  'Writing GRIB files': 'Écriture des fichiers GRIB',
  'Prepare files': 'Préparer les fichiers',
  'Tick at least one available dataset.': 'Cochez au moins un jeu de données disponible.',
  'Cancelled. No files were prepared.': 'Annulé. Aucun fichier n’a été préparé.',
  'Prepared GRIB files': 'Fichiers GRIB préparés',
  'Save': 'Enregistrer',
  'No values in this area for these times, so there is no file.': 'Aucune valeur dans cette zone pour ces échéances : pas de fichier.',
  'File details': 'Détails du fichier',
  'Model': 'Modèle',
  'Forecast run': 'Cycle de prévision',
  'Base time': 'Heure de base',
  'Grid': 'Grille',
  'Area': 'Zone',
  'Longitude convention': 'Convention de longitude',
  'GRIB messages': 'Messages GRIB',
  'Points with data': 'Points avec données',
  'Checksum (FNV-1a 64)': 'Somme de contrôle (FNV-1a 64)',
  'Times (UTC)': 'Échéances (UTC)',
  'Spot values': 'Valeurs ponctuelles',
  'grid point': 'point de grille',
  'Time (UTC)': 'Heure (UTC)',
  'Wind (kt)': 'Vent (nd)',
  'From (°)': 'Provenance (°)',
  'Gust (kt)': 'Rafale (nd)',
  'Current (kt)': 'Courant (nd)',
  'Set, towards (°)': 'Porte vers (°)',
  'Period (s)': 'Période (s)',
  'Wind waves (m)': 'Mer du vent (m)',
  'Wind-wave period (s)': 'Période de la mer du vent (s)',
  'Wind waves from (°)': 'Mer du vent, provenance (°)',
  'Swell (m)': 'Houle (m)',
  'Swell period (s)': 'Période de la houle (s)',
  'Swell from (°)': 'Houle, provenance (°)',
  'Data sources:': 'Sources des données :',
  'Wind – GFS': 'Vent – GFS',
  'Wind – ECMWF': 'Vent – ECMWF',
  'Waves – GFS-Wave': 'Vagues – GFS-Wave',
  'Currents – global (6-hourly)': 'Courants – global (toutes les 6 h)',
  'Currents – IBI regional (hourly, tide included)': 'Courants – IBI régional (horaires, marée incluse)',
  '6-hourly ocean-model currents. Tides are not resolved; do not use as tidal streams.': 'Courants d’un modèle océanique, toutes les 6 h. La marée n’est pas résolue : ne pas utiliser comme courants de marée.',
  'Hourly regional model currents including tide. Not an official tidal-stream prediction.': 'Courants horaires d’un modèle régional, marée incluse. Ce n’est pas une prédiction officielle des courants de marée.',
...
const FR_PATTERNS = [
  ...
  // Planner GRIB export: step counts, file sizes, horizon and size notes, coordinates.
  [/^1 step$/, '1 échéance'],
  [/^(\d+) steps$/, '$1 échéances'],
  [/^(≈ )?(\d+(?:\.\d+)?) (kB|MB)$/, (_match, approx = '', value, unit) => `${approx}${value} ${unit === 'kB' ? 'ko' : 'Mo'}`],
  [/^This forecast ends (.+) UTC, before the end of your window\.$/, 'Cette prévision s’arrête le $1 UTC, avant la fin de votre fenêtre.'],
  [/^These files would be about (\d+(?:\.\d+)?) (kB|MB), over the 200 MB limit\. Choose a coarser time step, a smaller margin or fewer datasets\.$/, (_match, value, unit) => `Ces fichiers feraient environ ${value} ${unit === 'kB' ? 'ko' : 'Mo'}, au-delà de la limite de 200 Mo. Choisissez un pas de temps plus grand, une marge plus petite ou moins de jeux de données.`],
