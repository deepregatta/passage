...
const dynamicKeys = {
  ...
  'A weather system crosses your passage window': 'Briefing.jsx: headline uses capitalize(plainEventNoun(...))',
  'A low-pressure system crosses your passage window': 'Briefing.jsx: headline uses capitalize(plainEventNoun(...))',
  'A deepening low crosses your passage window': 'Briefing.jsx: headline uses capitalize(plainEventNoun(...))',
  'A high-pressure ridge crosses your passage window': 'Briefing.jsx: headline uses capitalize(plainEventNoun(...))',
  'A weather front crosses your passage window': 'Briefing.jsx: headline uses capitalize(plainEventNoun(...))',
  'partially assessed': 'ModelsUsed.jsx and Briefing.jsx: status.replaceAll replaces underscores with spaces',
  'model agreement': 'Briefing.jsx: capability.replaceAll replaces underscores with spaces',
