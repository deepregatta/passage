...
- Status: in progress · Commit: — · Notes: Clean pre-flight at `3e0b1c6`; previous commit scope verified and exact-tree full guardrails just passed (112 engine + 43 viewer + 225 Python under Europe/Paris, Ruff lint/format). Generated demo byte-identical before/after 1.3; known drift remains under 1.15. No unrelated dirty files or untriaged findings.
