...
- Status: done · Commit: — · Notes: Design: factory publishes tides/index.json as {schema_version: 1, routes: {route_id: artifact_filename}} for registered artifacts actually present beside the index.
